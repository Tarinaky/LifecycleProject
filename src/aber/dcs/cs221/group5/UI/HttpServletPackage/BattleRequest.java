...
public class BattleRequest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().println("<img class=\"page_header\" src=\"battlerequests.png\" />");
		resp.getWriter().println("<table border=\"1\">");
		resp.getWriter().println("<tr>");
		resp.getWriter().println("<td class = \"title_row\">");
		resp.getWriter().println("<p>Friend's Name</p>");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class = \"title_row\">");
		resp.getWriter().println("<p>Monster Name</p>");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class = \"title_row\">");
		resp.getWriter().println("<p>Cash Prize</p>");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class = \"title_row\">");
		...
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
		resp.getWriter().println("<p>100</p>");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
