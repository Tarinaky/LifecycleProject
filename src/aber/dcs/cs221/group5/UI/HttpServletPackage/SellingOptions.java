...
public class SellingOptions extends HttpServlet{
...
protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().println("<li><a class=\"border\" href=\"http://localhost:8080/Monster_Mash/BreedOptions\">BreedOptions</a></li>");
		...
		resp.getWriter().println("<img class=\"page_header\" src=\"sellingoptions.png\" />");
		resp.getWriter().println("<table border=\"1\">");
		resp.getWriter().println("<tr>");
		resp.getWriter().println("<td class = \"title_row\">");
		resp.getWriter().println("<p>Monster Name</p>");
		...
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class = \"title_row\">");
		resp.getWriter().println("<p>Sell</p>");
		resp.getWriter().println("</td>");
		resp.getWriter().println("</tr>");
		...
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
		resp.getWriter().println("<input type=\"text\" name=\"amount\">");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
		...
		resp.getWriter().println("<form id=\"details1\" action =\"\" method=\"post\" onsubmit=\"return validate(this)\">");
		resp.getWriter().println("<tr>");
		resp.getWriter().println("<td class=\"td_request\">");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
		resp.getWriter().println("<input type=\"text\" name=\"amount1\">");
		resp.getWriter().println("</td>");
		resp.getWriter().println("<td class=\"td_request\">");
		resp.getWriter().println("<input type=\"radio\" name=\"response\" value=\"yes\">Yes");
		resp.getWriter().println("<input type=\"radio\" name=\"response\" value=\"no\">No<br /><br />");
