...
<div id="container">
	...
	<div id="content">
	    <img class="page_header" src="login.png" />
        <form id="details" action ="LoginController" method="get" onsubmit="return validate(this)">
           <p style="text-align:center;">UserName: <input type="text" name="userName" size="20" 
              maxlength="60" /> </p>
           <p style="text-align:center;">Password: <input type="password" name="password" size="20" 
              maxlength="60" /> </p>   
           <p style="text-align:center;"><input style = "text-align: center" type="submit" 
